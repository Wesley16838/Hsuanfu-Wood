...
var htmlfolder = "tw"; // src裡面的預設html資料夾
var tempfolder = "src/html-output/tw"; //預覽資料夾
var destfolder = "application/views/tw"; // 輸出php的預設資料夾，注意!!此資料夾的層級要與html-output的資料夾同級 //application/views/en
var jsplugin = {
