...
// controllers 名稱 // 須修改
class Cktmp_css extends Admin_Controller
{
  // 基本設定
  public $table = 'cktmp_css'; // 資料庫table name // 須修改
    ...
    if(
      $this->input->post('xtitle', true)
        ...
        $data = array(
          ...
          'xlang'=> ($this->input->post('xlang', true)) ? $this->input->post('xlang', true) : '',
          'xpath'=> ($this->input->post('xpath', true)) ? $this->input->post('xpath', true) : '',
