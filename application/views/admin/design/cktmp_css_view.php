                        ...
                        <div class="panel-body">
                          <fieldset class="form-horizontal">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">語系:</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="xlang" value="<?=(isset($list['xlang']))?$list['xlang']:''?>"></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">路徑:</label>
                              <div class="col-sm-10"><input type="text" class="form-control" name="xpath" value="<?=(isset($list['xpath']))?$list['xpath']:''?>"></div>
                            </div>
