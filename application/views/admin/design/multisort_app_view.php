                              ...
                              <div class="panel-body">
                                ...
                                <fieldset class="form-horizontal">
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <div class="btn-group" data-toggle="buttons">
                                        <label class="btn btn-default active"><input type="radio" value="yes" name="xpublish">是</label>
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">描述:</label>
                                    <div class="col-sm-10"><textarea class="form-control" rows='<?=$this->textrow?>' name="xsubtitle"><?=(isset($list['xsubtitle']))?$list['xsubtitle']:''?></textarea></div>
                                  </div>

                                  <div class="form-group"><label class="col-sm-2 control-label">縮圖:</label>
                                    <div class="col-sm-10">
                                      <?php $field = 'xfile1';?>
                                      <div class="col-sm-3">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <div class="btn-group" data-toggle="buttons">
                                        ...
                                        <label><input type="radio" value="insert" id="insert" name="xsort" onchange="readSort('<?=(isset($list['pid']))?$list['pid']:''?>','xtitle',true)">置入所選資料之後</label>
