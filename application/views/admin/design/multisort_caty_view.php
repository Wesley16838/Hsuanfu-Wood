                  ...
                  <div class="tabs-container">
                      ...
                      <div class="tab-content">
                              ...
                              <div class="panel-body">
                                ...
                                <fieldset class="form-horizontal">
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">主標:</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="xname" value="<?=(isset($list['xname']))?$list['xname']:''?>" placeholder="" required></div>
                                  </div>

                                  <div class="form-group"><label class="col-sm-2 control-label">代碼:</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="xcode" value="<?=(isset($list['xcode']))?$list['xcode']:''?>"></div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                      <div class="btn-group" data-toggle="buttons">
                                        ...
                                        <label><input type="radio" value="insert" id="insert" name="xsort" onchange="readSort('<?=(isset($list['pid']))?$list['pid']:''?>','xname',true)">置入所選資料之後</label>
                          ...
                          <div id="tab-2" class="tab-pane"> <!--須修改-->
                             <div class="panel-body">
                               <div class="form-group">
                                 <textarea name="xcontent"><?=(isset($list['xcontent']))?$list['xcontent']:''?></textarea>
                               </div>
                             </div>
                          </div>
                      </div>
